...
public class Movie {
    ...
    public enum Genre { ACTION, ADVENTURE, COMEDY, CRIME, DRAMA, HORROR, ROMANCE,MUSICAL,SUPERHERO, SCI_FI, THRILLER, ANIMATION, DOCUMENTARY }
    public enum Language { ENGLISH, SPANISH, FRENCH, GERMAN, MANDARIN, KOREAN, JAPANESE, HINDI, ARABIC }
