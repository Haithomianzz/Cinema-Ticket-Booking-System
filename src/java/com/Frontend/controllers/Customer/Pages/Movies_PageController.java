...
public class Movies_PageController {
    @FXML
    private ScrollPane MP_MLIST;
    @FXML
    private Label C_Username;
    @FXML
    private VBox MP_CLIST;
    @FXML
    ...
    public void initialize() {
        ...
        for (Movie.Genre genre : genres) {
            ...
            genreButton.setOnAction(event -> {
                ...
                currentGenre = genre;
                populateMovieGrid(movieGrid, allMovies, currentGenre, MP_Search.getText());
            });
            genreButton.setPrefWidth(250);
            genreButton.setPrefHeight(50);
            MP_CLIST.getChildren().add(genreButton);
        }
    }
    ...
    private void populateMovieGrid(GridPane movieGrid, HashSet<Movie> movies, Movie.Genre filterGenre, String searchQuery) {
        ...
        for (Movie movie : movies) {
            ...
            if ((filterGenre != null && !movie.getGenres().contains(filterGenre)) ||
