...
public class Main extends Application {
    ...
    public void start(Stage stage) throws IOException {
        primaryStage = stage; // Assign the stage
    ...
    // Keep utility methods if they don't belong to a specific controller
    // e.g., getDoctors(), getPatients(), getAppointments(), checkEmptyForm(), etc.
...
//        window = stage;
//        window.setTitle("Cinema Ticket Booking System v1.0");
...
//        // Menu Page
//        {
//            Image backgroundImage = new Image("com/Frontend/resources/background.jpg");
...
//            Label label = new Label("Welcome to the Cinema Ticket Booking System");
//            label.setStyle(H1);
